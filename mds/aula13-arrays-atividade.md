# aula13_Arrays atividade

Arquivo original: `aula13_Arrays atividade.pdf`

## Página 1

![Página 1](aula13-arrays-atividade_images/page-001.png)
...
![Página 2](aula13-arrays-atividade_images/page-002.png)
...
![Página 3](aula13-arrays-atividade_images/page-003.png)
...
![Página 4](aula13-arrays-atividade_images/page-004.png)
...
![Página 5](aula13-arrays-atividade_images/page-005.png)
...
![Página 6](aula13-arrays-atividade_images/page-006.png)
...
![Página 7](aula13-arrays-atividade_images/page-007.png)
...
![Página 8](aula13-arrays-atividade_images/page-008.png)
...
![Página 9](aula13-arrays-atividade_images/page-009.png)
...
![Página 10](aula13-arrays-atividade_images/page-010.png)

Vamos praticar?

1. Implemente o programa CatalogoLivros, que gerencia até 10 livros. Cada livro
...
•  E os seguintes atributos:
                                      titulo        String   Título do livro (texto livre)
...
![Página 11](aula13-arrays-atividade_images/page-011.png)
...
No main, crie Livro[] catalogo = new Livro[10]; e um índice posLivre = 0;.
Monte um loop while(true) com switch para o menu.

No cadastro, se posLivre < catalogo.length, leia dados via Scanner, instancie um Livro e armazene em
catalogo[posLivre], depois incremente posLivre. Caso contrário, mostre “Catálogo cheio”.

Para a listagem, percorra o array com um for (int  i = 0;  i < catalogo.length; i++) e exiba somente
posições não‐nulas.

Para buscar, leia o título, percorra com for indexado comparando equalsIgnoreCase.
Se achar, mostre posição; se não, informe que não encontrou.

Para as estatísticas, conte quantos elementos não são null usando for indexado.
Some os anos para calcular a média (double). Se total for 0, avise que não há livros.
Para encerrar o programa, ao escolher  Sair, exiba mensagem “Programa encerrado — X  livros
cadastrados”.
                                                                                                         11

## Página 12

![Página 12](aula13-arrays-atividade_images/page-012.png)
...
![Página 13](aula13-arrays-atividade_images/page-013.png)
